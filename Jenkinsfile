			...
			steps {
				dir('maven_app02') {
					sshagent(['tomcat-deployer-key']) {
						sh "scp -o StrictHostKeyChecking=no /home/jenkins/workspace/maven_app/maven_app02/target/java-hello-world.war root@192.168.98.239:/opt/tomcat/latest/webapps"
					}
				}
			}
		}
